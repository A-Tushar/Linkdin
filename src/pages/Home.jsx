...
const Home = () => {
  ...
  return (
   ...
   <div className='w-4/5 h-96 bg-slate-300 mx-auto my-5'>
    ...
    <div className="w-full h-2/4  relative">
      <Image classname={"h-44 w-44 rounded-full absolute top-[-20%] left-11"} src={userdata.photoURL} />
   ...
   <div className="flex justify-between bg-slate-600 w-4/5 h-10 mx-auto gap-1">
    <button className='w-1/3 py-2 px-12 bg-sky-800 font-main-font font-medium text-white'>PROFILE</button>
    <button className='w-1/3 py-2 px-12 bg-sky-100 font-main-font font-medium'>Friends</button>
    <button className='w-1/3 py-2 px-12 bg-sky-100 font-main-font font-medium'>Posts</button>
   </div>
   <Profile/>
   </>
  )
